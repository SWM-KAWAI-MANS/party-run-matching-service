...
@WebFluxTest(controllers = MatchController.class, excludeFilters = {
...
class MatchControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        this.webTestClient = WebTestClient.bindToController(new MatchController(matchService))
                .configureClient()
    ...
    void getWaiting() {
        ...
        webTestClient.get().uri("/match/event")
                .exchange()
                .expectStatus().isOk();
    }
}