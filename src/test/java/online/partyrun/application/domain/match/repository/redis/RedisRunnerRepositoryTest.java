...
class RedisRunnerRepositoryTest {
    ...
    @Autowired RedisRunnerRepository redisRunnerRepository;
    ...
    void successSave() {
        ...
        StepVerifier.create(findResult)
                .assertNext(result -> isSameRunner(result, runner1))
                .verifyComplete();
    }
    ...
    class 해당_도메인이_저장소에_존재할_떄 {
        ...
        void successFind() {
            final Mono<Runner> findResult =
                    redisRunnerRepository.findByMemberId(runner1.getMemberId());
