...
/**
 * {@link WaitingRepository}를 구현하는 Queue 입니다. InMemory 환경에서 동작할 수 있는 큐로 구성했습니다.
 *
 * <p>{@link EnumMap}을 통하여 각 {@link RunningDistance} 별 Queue를 별도로 구축했습니다.
 *
 * @author parkhyeonjun
 * @since 2023.06.29
 */
...
public class InMemoryWaitingQueue implements WaitingRepository {
    ...
    /**
     * queue에 runner를 저장합니다. 각 {@link RunningDistance} 별로 저장을 수행합니다.
     *
    ...
    public List<String> findTop(final RunningDistance distance, final int count) {
        ...
        return IntStream.range(0, count).mapToObj(i -> queue.poll()).toList();
    }
